...
import 'package:portfolio_app/view/projects/components/project_link.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(projectList[index].description,style: const TextStyle(color: Colors.grey,height: 1.5),),
        const Spacer(),
